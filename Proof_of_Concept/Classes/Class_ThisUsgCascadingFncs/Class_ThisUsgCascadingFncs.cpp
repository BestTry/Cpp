// Class_ThisUsgCascadingFncs.cpp : Pulled from Deitel - 'How to Program' Chapter 7 - Using 'this' to enable cascading functions calls.
//
//
						// The Preprocessor Directives: (Header Files) 	
#include "time6.h"		// Time class declaration header file
...
int main()									// Function main() begins program execution - Entry point for the program
{
	...
	cout << "         Demonstrate Using 'this' to enable cascading functions calls         \n\n" << endl;

	Time t;									// Cascaded function calls
	t.setHour(18).setMinute(30).setSecond(22);
	// Display output time in universal and standard formats
	cout << "Universal time: ";
	t.printUniversal();
	...
	cout << "\n\nNew standard time: ";
	t.setTime(20, 20, 20).printStandard();	// Cascaded function calls
