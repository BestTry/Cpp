// Class_ThisPointer.cpp : Code pulled from Deitel - 'How to Program' Chaper 7 - 'Using the this pointer'
//
//
...
public:
	Test(int = 0);								// Default constructor - initializing the private x variable to zero
	void print() const;
...
Test::Test(int value)							// Constructor that is normally used incorparating the 'Initialization Member Syntax'		
	       : x(value)							// Initialize variable 'x' to 'value' passed during instantiation of an object
{
	// empty body 
...
void Test::print() const
{
	...
	cout << " The keyword 'this' means that the operator is acting on \n"
		 << " 'this' present object, that is, pointing to it \n" << endl;

												// Implicitly use this pointer to access member in class 'Test'
	cout << " Implicitly use 'this pointer' to access member x:        x = " << x << " \n" << endl;
	
												// Explicitly use this pointer to access member x in class 'Test'
	cout << " Explicitly use 'this pointer' to access member x:  this->x = " << this->x << " \n" << endl;

												// Explicitly use dereferenced this pointer and 
												// the dot operator to access member x in class 'Test'
	cout << " Using dereferencing and dot operator:            (*this).x = " << (*this).x << endl;
...
int main()									// Function main() begins program execution - Entry point for the program
{
	...
	cout << "        Demonstrating Using the 'this' Pointer to Refer to Object Members       \n\n" << endl;

	Test testThisObject(12);				// Creating / Instantiating an object to test the 'this' pointer
	testThisObject.print();
