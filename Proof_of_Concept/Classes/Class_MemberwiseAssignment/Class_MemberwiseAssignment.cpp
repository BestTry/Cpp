// Class_MemberwiseAssignment.cpp : Pulled from Deitel - "How to Program' Chapter 6 - Membeerwise Assignment
...
// ............ In this example the class and functions are both declared and defined here due to the simplicity of the statements  .........

class Date {							// class Date Decalaration - Definition Combination
...
Date::Date(int m, int d, int y)			// Date constructor with no range checking
{
	month = m;
	day = d;
	year = y;
...
int main()									// Function main() begins program execution - Entry point for the program
{
	...
	cout << "           Demonstrating Copying Objects to other Objects        \n\n" << endl;

	Date date1(7, 4, 2002);
	Date date2;							// Date2 defaults to 1/1/1990 - via the default constructor initialization
