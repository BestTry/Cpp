...
using namespace std;	// Common practice to implement the "std" namespace as it contains multiple supporting useful functions
							...
							// +++++++ Necessary for 'GetConsoleWindow()' function below to work! - on Windows 2000 and later
#define _win32_winnt 0x0500	// Provide position of Console Window on the desktop PC screen
#include <windows.h>		// +++++++
...
{									
	...
	MoveWindow(console, 1700, 				// MoveWindow(window_handle, x, y, width, height, redraw_window);
		 500, 700, 1000, true);				// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
